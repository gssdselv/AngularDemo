...
namespace Flex.APT.FrameWork.Exceptions
{
    public class BaseBusinessException : System.Exception
    {
        //
        // Summary:
        ...
        public BaseBusinessException(string message, System.Exception innerException) : base(message, innerException)
        {
